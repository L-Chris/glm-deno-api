...
import { createCompletion, createCompletionStream, getModels, removeConversation } from "./api.ts";
...
app.post('/v1/chat/completions', async (c) => {
  ...
  if (chatConfig.stream) {
    ...
    }, () => removeConversation(chatConfig.chat_id, token))
